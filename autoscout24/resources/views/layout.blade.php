...
<head>
  ...
  <!-- site favicon -->
  <link rl="shortcut icon" type="image/png" href={{ asset("assets/images/favicon.jpg") }} />
          ...
          <div class=" col-sm-8">
            <div class="footer-widget widget-about">
              <div class="widget-about-content">
                <a href="index.html" class="footer-logo"><img src={{  asset("assets/images/logo-footer.png")  }}  alt="logo"></a>
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-sm-6">
            <ul class="payment-method d-flex justify-content-end">
              <li>We accept</li>
              <li><img src={{ asset("assets/images/money-method/1.png") }} alt="image"></li>
              <li><img src={{ asset("assets/images/money-method/2.png") }} alt="image"></li>
              <li><img src={{ asset("assets/images/money-method/3.png") }} alt="image"></li>
            </ul>
          </div>
        </div>
      </div>
